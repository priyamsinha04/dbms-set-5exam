...
INSERT INTO Flight_info (Flight_id, Company_name, Dest_from, Dest_to, 
Class, Fare) VALUES
...
INSERT INTO Passenger_info (Pass_id, Pass_name, Pass_city, Pass_DOB, 
Flight_id) VALUES
('P001', 'Rajesh Kumar', 'Mumbai', TO_DATE('1980-04-21', 'YYYY-MM-DD'), 
'FL101');
INSERT INTO Passenger_info (Pass_id, Pass_name, Pass_city, Pass_DOB, 
Flight_id) VALUES
('P002', 'Anita Sharma', 'Chennai', TO_DATE('1992-11-13', 'YYYY-MM-DD'), 
'FL102');
INSERT INTO Passenger_info (Pass_id, Pass_name, Pass_city, Pass_DOB, 
Flight_id) VALUES
('P003', 'Vikram Singh', 'Kolkata', TO_DATE('1985-07-19', 'YYYY-MM-DD'), 
'FL103');
INSERT INTO Passenger_info (Pass_id, Pass_name, Pass_city, Pass_DOB, 
Flight_id) VALUES
('P004', 'Priya Patel', 'Pune', TO_DATE('1990-02-25', 'YYYY-MM-DD'), 
'FL104');
INSERT INTO Passenger_info (Pass_id, Pass_name, Pass_city, Pass_DOB, 
Flight_id) VALUES
